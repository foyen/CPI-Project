...
if( abs(point_distance(x, y, obj_player.x, obj_player.y)) < 300 )  // near player
{ 
	...
	if(abs (point_distance(x,y, obj_player.x , obj_player.y)) < 275) // too close
	{	
		move_towards_point(x, y, 0) 
		Calc_img_angle( obj_player.x , obj_player.y, self)
	}
	else
	{
